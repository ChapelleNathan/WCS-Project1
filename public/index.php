    ...
    <header>
        ...
        <nav>
            ...
            <a href="#navigation" class="linkList">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="list"
                    viewBox="0 0 16 16">
            ...
            <div class="navigation" id="navigation">
                <a href="#" class="linkCloseBurger">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="closeBurger" viewBox="0 0 16 16">
                        <path
    ...
    <footer>
        ...
        <div class="contactMe">
            <a href="http://www.spontex.fr" target="_blank">
                <h3 class="linkedin">LinkedIn : <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
            ...
            <div class="mail">
                <a href="mailto:bobeponge@bikinibottom.eau">
                    <h3>Gmail : <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
